...
**Версия:** 1.0  
**Последнее обновление:** 2026-07-02 19:00 UTC  
**Обновил:** Qwen (архитектурный аудит)  
...
- [ ] **0.1** 🔴 Остановить freebuffd (освободить 40% RAM)
  - **Статус:** ⏳ Ожидает
  - **Кто:** [свободно]
  - **Команда:** `sudo systemctl stop freebuffd && sudo systemctl disable freebuffd`
...
- [ ] **2.1** 🔴 Реализовать ScenarioPolicy (Pydantic)
  - **Статус:** ⏳ Ожидает
  - **Кто:** [свободно]
  - **Файл:** `/opt/leviathan_engine/agent_service/lap/kernel/policy.py`
